...
const ERC20Policy = ({ policyData, signupState, setSignupState, onNext, onBack }: PolicyProps) => {
  ...
  const requirementsDescription = `This poll requires you to have at least ${threshold} tokens at ${tokenAddress}`;
  ...
  }, [isConnected, isRegistered, userBalance, threshold, tokenAddress, setSignupState]);
