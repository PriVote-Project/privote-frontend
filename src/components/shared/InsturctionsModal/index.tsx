    ...
    <Modal title="How to Vote" isOpen={isOpen} onClose={onClose} showCloseButton maxWidth="600px">
      ...
      <div className={styles.instructions}>
        <ol>
          ...
          <li>
            Login to the mAadhaar app with your Aadhaar credentials and generate a QR code. Save it.
          </li>
          <li>
            Click on the Aadhaar login button on the Privote's poll page and upload your QR code.
          </li>
          ...
          <li>
            Distribute your votes to the projects you like (remember, it's quadratic voting, so
            spreading votes wisely is key!).
          </li>
        ...
        <div className={styles.note}>
          <p>
            📢 Share this with others to get more votes for your favorite projects! Anyone with a
            valid Aadhaar can vote.
          </p>
          <p>Happy Voting! 🗳️🚀</p>
        </div>
      </div>
